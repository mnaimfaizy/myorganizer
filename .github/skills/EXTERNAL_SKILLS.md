...
Exact package and skill names below were verified with `npx skills find` on April 26, 2026, except `GoogleChrome/modern-web-guidance` which is verified via the upstream install docs on August 3, 2026.
...
npx skills add GoogleChrome/modern-web-guidance -y
