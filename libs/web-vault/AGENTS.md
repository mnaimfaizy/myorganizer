...
- Leave `putServerVaultMetaEtagAware` to the first sync against a server that holds no Vault Meta. Every other meta write is a wrapping being overwritten, and there is no way to tell from here whose it was.
