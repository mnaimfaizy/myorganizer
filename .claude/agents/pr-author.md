...
name: PrAuthor
description: >
  Use when the user asks to draft a pull request title and body from the current branch. Read-only — produces TITLE plus Markdown body only and does not create the PR.
