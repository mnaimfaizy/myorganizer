...
name: Designer
description: >
  Use when a design brief needs turning into a House Explainer Page — a self-contained HTML artifact under docs/. Produces and verifies the page. What the page is for, and every fact in it, stay with the design-brief skill.
