...
1. Read and follow `.agents/skills/implement/SKILL.md` exactly.
...
6. Route Jest / Playwright / Storybook / components / API Contract by **gate + file type** (not absolute always-delegate).
