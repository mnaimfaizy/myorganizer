...
1. Read and follow `.agents/skills/tdd/SKILL.md` exactly.
2. Also read `.agents/skills/codebase-design/SKILL.md` — referenced during the Refactor step for deep-module vocabulary.
