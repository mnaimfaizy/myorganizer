...
1. Read and follow `.agents/skills/domain-modeling/SKILL.md` exactly.
...
6. **Offer ADRs sparingly** — only when all three conditions are met: hard to reverse, surprising without context, result of a real trade-off. Use the format in `.agents/skills/domain-modeling/ADR-FORMAT.md`.
