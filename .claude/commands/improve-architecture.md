...
1. **First**, read `.agents/skills/codebase-design/SKILL.md` for the shared vocabulary (module, interface, depth, seam, adapter, leverage, locality). Also read its companion files:
...
2. Read and follow `.agents/skills/improve-codebase-architecture/SKILL.md` exactly.
