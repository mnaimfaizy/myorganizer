...
| [`docs/adr/0053-…`](docs/adr/0053-a-fan-out-over-a-domain-enum-is-pinned-at-its-call-site.md)                    | Code fanning out over a domain enum reaches one `satisfies Record<…>` Pinned Table rather than re-enumerating the members. Enforced for Guarded Enums by `yarn enum:fanout:check`.                                                              |
| [`docs/ui/GUIDELINES.md`](docs/ui/GUIDELINES.md)                                                                 | UI components: composition, structure, accessibility.                                                                                                                                                                                           |
| [`docs/review/REVIEW_CHECKLIST.md`](docs/review/REVIEW_CHECKLIST.md)                                             | Review obligations: the questions a reviewer answers in writing, each bought by an incident. Read whole by a human. **Not** loaded as a standards source by the code-review skill — its entries reach an agent already selected, as a worklist. |
