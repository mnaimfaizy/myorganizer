...
Options:
  ...
  --label <name>          Surface Label (ADR 0025) or the agent-review Request Label (ADR 0069) to apply. Repeat the flag or pass a comma-separated list. Default: none.
...
function validateLabels(labels, catalog) {
  ...
  fail(
    `Not Surface Labels (ADR 0025) or the agent-review Request Label (ADR 0069): ${rejected.join(', ')}. Use kind/area/trigger names from tools/config/github-labels.json.`,
  );
}
