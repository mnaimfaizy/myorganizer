...
| **YouTube**        | Server-side OAuth with a separate channel refresh and upload sync, a channels page, a channel-first directory, an in-session queue, and a time-capped Shorts budget |
