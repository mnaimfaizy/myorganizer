...
- [ ] Identify opportunities for deep modules (small interface, deep implementation) — run the `codebase-design` skill (`.agents/skills/codebase-design/SKILL.md`) for the vocabulary and testability checks
