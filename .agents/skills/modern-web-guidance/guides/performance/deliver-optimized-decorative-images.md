...
.gallery-item {
  ...
  background-image: image-set(url('gallery.avif') type('image/avif') 1x, url('gallery-2x.avif') type('image/avif') 2x, url('gallery.webp') type('image/webp') 1x, url('gallery-2x.webp') type('image/webp') 2x, url('gallery.jpg') type('image/jpeg') 1x, url('gallery-2x.jpg') type('image/jpeg') 2x);
...
.gallery-item {
  ...
  background-image: image-set(url('gallery.avif') type('image/avif') 1x, url('gallery-2x.avif') type('image/avif') 2x, url('gallery.jpg') type('image/jpeg') 1x, url('gallery-2x.jpg') type('image/jpeg') 2x);
}
```
