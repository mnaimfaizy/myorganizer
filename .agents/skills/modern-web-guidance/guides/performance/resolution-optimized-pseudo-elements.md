...
.icon-button::before {
  ...
  content: image-set(url('icon.avif') type('image/avif') 1x, url('icon-2x.avif') type('image/avif') 2x, url('icon.webp') type('image/webp') 1x, url('icon-2x.webp') type('image/webp') 2x, url('icon.png') type('image/png') 1x, url('icon-2x.png') type('image/png') 2x);
...
.icon-button::before {
  ...
  content: image-set(url('icon.avif') type('image/avif') 1x, url('icon-2x.avif') type('image/avif') 2x, url('icon.png') type('image/png') 1x, url('icon-2x.png') type('image/png') 2x);
}
```
