...
```html
<input type="email" id="email" name="email" autocomplete="username" required /> <input type="password" id="password" name="password" autocomplete="current-password" required />
```
